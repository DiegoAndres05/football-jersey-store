...
Como visitante en un teléfono (~390 px), quiero ver **una** camiseta completa al frente, con nombre y acción legibles, y pasar de foto con un gesto o un indicador fácil de pulsar, para no pelear con tarjetas laterales cortadas ni puntos diminutos.

**Why this priority**: Es el fallo más visible: overflow, peek confuso y dots casi intocables.

**Independent Test**: Abrir el inicio a ~390 px de ancho con al menos dos fotos en Destacadas; se ve una sola tarjeta entera; el título no se corta a mitad de palabra de forma ilegible; los indicadores se pueden pulsar con el dedo; el deslizamiento cambia de camiseta.

**Acceptance Scenarios**:

1. **Given** el carrusel visible en un viewport estrecho (~390 px), **When** mira el bloque Destacadas, **Then** hay **una** tarjeta centrada y completa; no hay laterales recortadas ni un peek que tape el título.
...
3. **Given** escritorio, **When** mira el bloque, **Then** la tarjeta activa es obvia; las vecinas (si se ven) son un peek legible, no recortes que impidan reconocer la foto. En móvil no hace falta perceibir coverflow.
...
- Redimensionar de escritorio a ~390 px (o al revés): una tarjeta completa en estrecho; en ancho, flechas y peek más calmado.
...
- **FR-001**: En viewport estrecho el bloque Destacadas MUST mostrar una sola tarjeta completa, centrada, sin overflow ilegible de título/subtítulo y sin laterales recortadas.
...
- **FR-003**: MUST existir swipe horizontal funcional en viewport estrecho (y no debe impedir el scroll vertical de la página).
...
- **FR-007**: En escritorio, la tarjeta activa MUST ser dominante y obvia. Los peeks laterales, si existen, MUST ser más legibles que un recorte agresivo. En móvil MUST NOT exigirse efecto coverflow.
...
- **SC-001**: En una pasada a ~390 px de ancho, el 100% de las revisiones ven una sola tarjeta completa y pueden leer nombre y CTA sin recorte que los haga ilegibles.
...
- El umbral “móvil / estrecho” es el de un teléfono típico (~390 px); escritorio es el viewport ancho habitual.
